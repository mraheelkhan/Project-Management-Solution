...
<input name="department_id" type="hidden" value="{{ $user->department_id }}">
<input name="designation_id" type="hidden" value="{{ $user->designation_id }}">
<input name="designation_id" type="hidden" value="{{ $user->role_id }}">
<div class="box-body" >
<div class="row">
