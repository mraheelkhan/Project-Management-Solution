              ...
              <div class="col-md-8">
                ...
                {{--                 
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="date" class="form-control" id="dob" name="dob" placeholder="Date of Birth" value="{{ $user->staffdetails->dob ? $user->staffdetails->dob->format('Y-m-d')  : null }}" autocomplete="off" required>
                            @if ($errors->has('dob'))
                                <span class="text-red">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                  <input type="text" class="form-control" id="city" name="city" placeholder="City" value="{{ $user->staffdetails->city }}" autocomplete="off" require>
                                  @if ($errors->has('city'))
                                        <span class="text-red">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="phonenumber" name="phonenumber" placeholder="Mobile Number" value="{{ $user->phonenumber }}" autocomplete="off" require>
