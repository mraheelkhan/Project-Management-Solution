...
@if (Route::currentRouteName()=='createTasks' || Route::currentRouteName()=='editProjectTasks' or Route::currentRouteName()=='hrleads' or Route::currentRouteName()=='interviewees' or Route::currentRouteName()=='interviews'  or Route::currentRouteName()=='admins.create' or Route::currentRouteName()=='admins.edit'  or Route::currentRouteName()=='admins.show') 
  <!--For Date Pickers-->
  <!-- Date Picker CSS -->
...
@if (Route::currentRouteName()=='admins.create' or Route::currentRouteName()=='admins.edit')
  <script src="//cdnjs.cloudflare.com/ajax/libs/moment.js/2.9.0/moment-with-locales.js"></script>
  <script src="{{ asset('public/bower_components/bootstrap-daterangepicker/daterangepicker.js') }}"></script>
  <link href="{{ asset('public/bower_components/bootstrap-daterangepicker/daterangepicker.css') }}" rel="stylesheet">
@endif
<!-- For Select2 -->
@if (Route::currentRouteName()=='projects.edit' or \Request('projects') ) 
