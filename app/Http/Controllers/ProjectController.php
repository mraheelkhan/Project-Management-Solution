...
class ProjectController extends Controller
{
    ...
    public function create(){
        ...
        return view('projects.create',compact('customers','data'));
    }
    /* public function create1($customerid=null, $leadid=null)
    {
    ...
    public function show($id, Request $request)
    {
        ...
        $projectDetail = \App\Project::with('customer')->with('createdby')->where('id',$id)->first();
    ...
    public function edit($id)
    {
        ...
        //dd($project->users);
		return view('projects.edit', compact('project','customers','user'));
    }
